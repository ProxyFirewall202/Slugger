...
//Key detection
_xvel += ((keyboard_check(vk_right) || keyboard_check(ord("D"))) - (keyboard_check(vk_left) || keyboard_check(ord("A")))) * _speed * delta;
...
var _spawn_rate = delta / 32 - (abs(_xvel) + abs(_yvel));
